...
public class MessageController {
    ...
    public UUID createMessage(@AuthenticationPrincipal Jwt jwt, @Valid @RequestBody MessageCreateRequest createRequest) {
        String claim = Objects.requireNonNull(jwt.getClaimAsString(JwtCustomClaim.USER_ID));
        return messageService.createMessage(UUID.fromString(claim), createRequest);
    }
